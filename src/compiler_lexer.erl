...
yystate(89, [10|Ics], Line, Tlen, _, _) ->
    yystate(89, Ics, Line+1, Tlen+1, 0, Tlen);
...
yystate(87, [60|Ics], Line, Tlen, Action, Alen) ->
...
yystate(87, [37|Ics], Line, Tlen, Action, Alen) ->
...
yystate(86, [83|Ics], Line, Tlen, Action, Alen) ->
...
yystate(85, [59|Ics], Line, Tlen, _, _) ->
...
yystate(85, Ics, Line, Tlen, _, _) ->
    {0,Tlen,Ics,Line,85};
yystate(84, [79|Ics], Line, Tlen, Action, Alen) ->
...
yystate(83, Ics, Line, Tlen, _, _) ->
    {19,Tlen,Ics,Line,83};
yystate(82, [69|Ics], Line, Tlen, Action, Alen) ->
...
yystate(73, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(73, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 40 ->
    yystate(73, Ics, Line, Tlen+1, Action, Alen);
yystate(73, [C|Ics], Line, Tlen, Action, Alen) when C >= 42 ->
    yystate(73, Ics, Line, Tlen+1, Action, Alen);
...
yystate(70, [87|Ics], Line, Tlen, _, _) ->
...
yystate(65, Ics, Line, Tlen, _, _) ->
    {27,Tlen,Ics,Line};
yystate(64, [76|Ics], Line, Tlen, Action, Alen) ->
...
yystate(55, Ics, Line, Tlen, _, _) ->
    {6,Tlen,Ics,Line};
yystate(54, [71|Ics], Line, Tlen, Action, Alen) ->
...
yystate(52, [73|Ics], Line, Tlen, _, _) ->
...
yystate(47, [76|Ics], Line, Tlen, Action, Alen) ->
...
yystate(45, Ics, Line, Tlen, _, _) ->
    {26,Tlen,Ics,Line,45};
yystate(44, [78|Ics], Line, Tlen, Action, Alen) ->
...
yystate(35, [65|Ics], Line, Tlen, Action, Alen) ->
...
yystate(29, Ics, Line, Tlen, _, _) ->
    {20,Tlen,Ics,Line,29};
yystate(28, [77|Ics], Line, Tlen, Action, Alen) ->
...
yystate(23, [72|Ics], Line, Tlen, Action, Alen) ->
...
yystate(21, [32|Ics], Line, Tlen, _, _) ->
    yystate(25, Ics, Line, Tlen+1, 24, Tlen);
...
yystate(13, Ics, Line, Tlen, _, _) ->
    {23,Tlen,Ics,Line};
yystate(12, [70|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(12, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,12};
yystate(11, [78|Ics], Line, Tlen, Action, Alen) ->
